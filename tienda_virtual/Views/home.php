...
<!--===============================================================================================-->	
	<link rel="icon" type="image/ico" href="<?= media() ?>images/uploads
	/zc-ico.ico"/>
<!--===============================================================================================-->
	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Envío gratis para pedidos estándar superiores a ##
					</div>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="http://zcpublicidad.com/tienda_virtual" class="logo">
						<img src="<?= media() ?>images/uploads/zc.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								<a href="http://zcpublicidad.com/tienda_virtual">Inicio</a>
							</li>
							...
							<li class="label1" data-label1="hot">
								<a href="shoping-cart.html">Características</a>
									<ul class="sub-menu">
									<li><a href="index.html">title 1</a></li>
									<li><a href="home-02.html">title 2</a></li>
									<li><a href="home-03.html">title  3</a></li>
								</ul>
							</li>
						...
						<!-- 	<li>
							...
							<li>
								<a href="http://www.zcpublicidad.com/contact/">Contacto</a>
							</li>
						</ul>
					</div>	
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="http://zcpublicidad.com/tienda_virtual/"><img src="<?= media() ?>images/uploads/zc.png" alt="IMG-LOGO"></a>
			</div>
			...
			<ul class="main-menu-m">
				...
				<li>
					...
					<ul class="sub-menu-m">
						...
						<li><a href="home-02.html">title</a></li>
						<li><a href="home-03.html">title</a></li>
					</ul>
			...
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="flex-w flex-c-m m-tb-10">
					...
					<div class="flex-c-m stext-106 cl6 size-105 bor4 pointer hov-btn3 trans-04 m-tb-4 js-show-search">
						<i class="icon-search cl2 m-r-6 fs-15 trans-04 fas fa-search"></i>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						¿Alguna pregunta? Háganos saber llámenos al (+0)-000-000
					</p>
...
ZCpublicidad &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados | Esta plantilla está hecha con  <i class="fa fa-heart-o" aria-hidden="true"></i>  Por <a href="https://colorlib.com" target="_blank">Colorlib</a>. 
Descargado de <a href="https://themeslab.org/" target="_blank">Themeslab</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
